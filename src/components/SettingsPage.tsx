  ...
  return (
    <div className="max-w-5xl mx-auto px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-500 pt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div>
                  <span className="text-sm font-bold text-slate-900 block group-hover:text-sky-500 transition-colors">
                    {hasPin ? 'Alterar Código PIN' : 'Criar Código PIN'}
                  </span>
                  {!hasPin && (
        ...
        {/* SISTEMA */}
        <div className="md:col-span-2 bg-slate-50 border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-md grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-100">
          <button
            onClick={handleClearCache}
            className="p-8 text-left hover:bg-slate-100 flex items-center justify-between group transition-colors"
          >
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-slate-900 font-bold text-base leading-none">Termos e Privacidade</p>
                <p className="text-slate-500 text-xs mt-1">
                  Como protegemos e tratamos seus dados
                </p>
              </div>
            </div>
        ...
        <div className="md:col-span-2 p-8 border border-red-500/20 bg-red-500/5 rounded-[3rem] shadow-lg">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-red-500 font-black text-xs uppercase tracking-[0.2em]">
              Gerenciamento Crítico da Conta
            </h3>
          </div>
          ...
          <p className="text-red-400/60 text-[9px] mt-4 text-center font-bold uppercase tracking-tighter">
            A exclusão da conta é irreversível e remove todos os dados de lançamentos, metas e interações com a IA.
          </p>
        </div>
      </div>
