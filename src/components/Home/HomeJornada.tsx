  ...
  dividas: [
    {
      ...
      title: 'Jogue a luz nas suas dívidas',
      body: 'Cadastre o que você deve — cartão, crédito, parcelamentos. Ver tudo junto, com custo real e prazo, é o primeiro passo para sair do modo reativo.',
    },
    {
      n: 2,
      iconBg: 'bg-sky-100',
      iconText: 'text-sky-700',
      title: 'Descubra qual dívida custa mais caro',
      body: 'O Nexus analisa sua lista e te mostra por onde atacar primeiro. Não é chute — é cálculo com base na taxa real de cada dívida.',
    },
    {
      n: 3,
      iconBg: 'bg-emerald-100',
      iconText: 'text-emerald-700',
      title: 'Siga o plano e veja o progresso',
      body: 'À medida que você quita, o sistema atualiza automaticamente. Você para de carregar essa conta na cabeça — o Finanças Pro Invest carrega por você.',
    },
  ],
  patrimonio: [
    {
      ...
      iconBg: 'bg-emerald-100',
      iconText: 'text-emerald-700',
      title: 'Consolide tudo num só lugar',
    ...
    },
    {
      ...
      iconBg: 'bg-sky-100',
      iconText: 'text-sky-700',
      title: 'Acompanhe a evolução mês a mês',
    ...
    },
    {
      ...
      title: 'O Nexus avisa quando algo merece atenção',
