        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t border-slate-200 pt-6">
            <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2 mb-4">
              <Bell size={16} className="text-emerald-500" /> Lembretes
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <Calendar size={20} className="text-emerald-500" /> Suas Metas
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {goals.map((goal) => {
              ...
              return (
                <div
                  key={goal.id}
                  className={`bg-white backdrop-blur-md border rounded-xl p-5 hover:border-slate-300 transition-colors group relative overflow-hidden shadow-sm ${
                    goal.ativa ? 'border-slate-200' : 'border-slate-200 opacity-70'
                  }`}
                >
                  {/* Indicador de status */}
                  <div
