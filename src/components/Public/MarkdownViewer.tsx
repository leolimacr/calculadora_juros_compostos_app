    ...
    <div className="prose prose-invert prose-emerald max-w-none prose-headings:font-black prose-a:text-emerald-400 hover:prose-a:text-emerald-300">
      <ReactMarkdown 
        ...
        components={{
          ...
          p: ({node, ...props}) => <p className="text-slate-400 mb-4 leading-relaxed text-base" {...props} />,
          ul: ({node, ...props}) => <ul className="list-disc list-inside text-slate-400 mb-4 pl-4 space-y-2" {...props} />,
          ol: ({node, ...props}) => <ol className="list-decimal list-inside text-slate-400 mb-4 pl-4 space-y-2" {...props} />,
