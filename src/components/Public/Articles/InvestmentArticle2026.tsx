...
export const InvestmentArticle2026 = ({ onNavigate }: any) => (
  <div className="max-w-4xl mx-auto px-6 py-12 text-slate-700 leading-relaxed font-sans animate-in fade-in duration-500 pb-32">
    <button onClick={() => onNavigate('home')} className="mb-10 text-sky-600 font-bold flex items-center gap-2 hover:underline text-xs uppercase tracking-widest">
      <ChevronLeft size={16}/> Voltar para o Hub
    </button>
    
    <div className="space-y-10">
      <header className="space-y-4">
         <span className="bg-emerald-50 text-emerald-600 px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest uppercase border border-emerald-200">Dossiê Estratégico 2026</span>
         <h1 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight tracking-tighter">
            O Novo Ciclo da Riqueza: <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-sky-600">Estratégia e Inteligência em 2026</span>
         </h1>
      </header>
      
      <p className="text-xl text-slate-500 font-medium leading-relaxed border-l-4 border-emerald-500 pl-6 py-2">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-black text-slate-900">1. O Cenário Macro</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 my-12">
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
          <Zap className="text-sky-600 mb-4" size={28}/>
          <h3 className="text-slate-900 font-bold text-lg mb-2">Poder da Antecipação</h3>
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
          ...
          <h3 className="text-slate-900 font-bold text-lg mb-2">Blindagem Patrimonial</h3>
      ...
      <section className="bg-gradient-to-br from-slate-100 to-white p-10 rounded-[3rem] border border-emerald-200 shadow-sm relative overflow-hidden group">
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-emerald-500/10 blur-[60px] rounded-full"></div>
        <h2 className="text-2xl font-black text-slate-900 mb-6 relative z-10">Por que o Controla é sua arma principal?</h2>
        <div className="space-y-4 relative z-10">
            <div className="flex items-start gap-3">
                <CheckCircle2 className="text-emerald-500 mt-1" size={18}/>
                <p className="text-slate-700"><strong>Controle de Sangramento:</strong> Identifique gastos invisíveis que corroem sua capacidade de aporte mensal.</p>
            </div>
            <div className="flex items-start gap-3">
                <CheckCircle2 className="text-emerald-500 mt-1" size={18}/>
                <p className="text-slate-700"><strong>Clareza de Metas:</strong> Transforme o 'sonho da liberdade' no número exato da sua Independência Financeira (FIRE).</p>
            </div>
        </div>
