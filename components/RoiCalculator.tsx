...
const RoiCalculator: React.FC<RoiCalculatorProps> = ({ isPrivacyMode = false, navigateToHome }) => {
  ...
  return (
    <div className="space-y-6">
      {navigateToHome && <Breadcrumb items={[{ label: 'Home', action: navigateToHome }, { label: 'Calculadora ROI' }]} />}
